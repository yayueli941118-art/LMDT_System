...
| 参数 | 校准依据 | 来源 |
|------|---------|------|
| 教育回报率 (年均 8-10%) | 中国城镇教育回报率微观估计 | 李实, 丁赛 (2003) + 张车伟 (2006) |
| 工作经验回报 (二次型，峰值 30年) | 标准明瑟方程 + 中国 CHIP 数据 | Mincer (1974) + 赵西亮 (2017) |
| 培训溢价 (一般 5%, 特殊 3%) | 培训对工资的因果效应估计 | 李湘萍, 郝克明 (2007) |
...
- 李实, 丁赛 (2003). 中国城镇教育收益率的长期变动趋势. 中国社会科学.
- 张车伟 (2006). 人力资本回报率变化与收入差距. 经济研究.
- 李实, 宋锦, 刘小川 (2014). 中国城镇职工性别工资差异的演变.
    """)
