...
def get_lab_css(theme_color: str, theme_dark: str) -> str:
    """生成特定实验室的主题 CSS"""
    return SHARED_CSS.format(color=theme_color, dark=theme_dark, light=theme_color)

# 兼容旧接口
CARD_CSS = "card"  # 类名
PAGE_BANNER_CSS = "page-banner"  # 类名
